...
void Cube::Render(IShader& _shader)
{
...
void Cube::Translate(float _x, float _y, float _z)
{
}

void Cube::Rotate(float _angleX, float _angleY, float _angleZ)
{
}

void Cube::Scale(float _scaleX, float _scaleY, float _scaleZ)
{
}
